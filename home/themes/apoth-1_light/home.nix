  ...
  config = mkIf cfg.enable {
    ...
    theme = {
      ...
      wallpapers = rec {
        ...
        images = {
          vert1 = pkgs.fetchurl {
            url = "https://w.wallhaven.cc/full/je/wallhaven-je3zm5.jpg";
            hash = "sha256-M0KvBicYJ8sd+Zu/wftof+r5aUtDJh38piSyHBohKDY=";
          };
          horz1 = pkgs.fetchurl {
            url = "https://w.wallhaven.cc/full/o5/wallhaven-o5v1wp.jpg";
            hash = "sha256-NpBpFMceLXvPlvfS0JJTMkuO8gr6YrYPVGZtD87/kBA=";
          };
          horz2 = pkgs.fetchurl {
            url = "https://w.wallhaven.cc/full/21/wallhaven-21y1ly.jpg";
            hash = "sha256-d8n+7mStwn6PPB65CGJ/+dkcnJUsvGNJARXDrW2YimI=";
          };
        };
      };
    };
